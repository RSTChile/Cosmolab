// Shim mínimo de DOM para ejecutar el <script> real de v7.5.html dentro de
// Node, sin navegador. Copia de shim_html2.mjs (v7.4.1) apuntando al archivo
// nuevo y exponiendo medirRecuperacion/varianzaYAutocorr además de lo ya
// expuesto (runSweep, setSeed, stepHeadless, etc.).
...
const HTML_PATH = path.join(__dirname, '..', 'EIT3_Termico_kappaH_v7.5.html');
...
;globalThis.__api = {
  ...
  runSweep,
  medirRecuperacion, varianzaYAutocorr,
...
export function buildSandbox() {
  ...
  vm.runInContext(code, context, { filename: 'sim-script-v75.js' });
