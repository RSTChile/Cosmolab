// Lista de barridos (jobs) para Experimento D, A' y B' de la segunda batería.
// Eje y settle/measure iguales para los tres (0.25->1.95, 60 puntos,
// settle=300, measure=120 — el que salió viable del chequeo de costo real).
export const EJE = { from: 0.25, to: 1.95, steps: 60, settle: 300, measure: 120 };
