// Paso 0 rehecho específicamente contra v7.6.1 — no se asume que hereda la
// validación de v7.5, sobre todo con el generador reestructurado (dos flujos,
// resembrado por fase). Zona rápida del eje (1.2->1.4) para no pagar el costo
// de asentarHastaEquilibrio/medirRecuperacion en esta prueba de reproducibilidad.
...
async function main() {
  console.log('=== Paso 0 (v7.6.1) — verificación obligatoria ===');
  const resultados = {};
