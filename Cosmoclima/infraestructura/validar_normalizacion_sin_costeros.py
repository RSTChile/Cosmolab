...
# ★ Los 6 puntos costeros cuya coordenada cae en el agua (verificado el 19-ago
# contra ESA WorldCover a 10 m y contra la capa de comunas): elevación 0 y
# pendiente 0, y la lluvia que se bajó para ellos es lluvia sobre el mar.
# Se excluyen aquí para medir CUÁNTO contaminaban el resultado publicado.
COSTEROS_EN_AGUA = {
    "ReTeRM · Puerto Montt", "ReTeRM · Arauco", "ReTeRM · Talcahuano",
    "ReTeRM · Concón", "ReTeRM · Valdivia", "ReTeRM · Puerto Varas",
}
...
def main():
    ...
    for o in obs:
        ...
        if o["territorio_id"] in COSTEROS_EN_AGUA:
            continue                       # ← el filtro de esta variante
    ...
    print("=" * 74)
    print("¿LA NORMALIZACIÓN APORTA?  — SIN LOS 6 PUNTOS COSTEROS EN EL AGUA")
    print("=" * 74)
