"""
cs090_fase7_f706_correr.py — FASE VII, tarea F7-06: corre Phantom sobre las condiciones iniciales que
escribió `cs090_fase7_f706_cupos.py` (5 brazos × 12 grafos base, N=2000, masa total fija 18800).
...
`cosmog.in` tras el `phantomsetup`, con `assert` de que el bloque por defecto es el esperado. Tampoco
recomputa: si la carpeta ya tiene `cosmog_00500`, la salta.

USO
---
    ./venv/bin/python cs090_fase7_f706_correr.py                 # todas las carpetas
    ./venv/bin/python cs090_fase7_f706_correr.py --shard=0/4     # un cuarto (para paralelizar)
"""
...
if __name__ == "__main__":
    ...
    print(f"[f706] {len(carpetas)} carpetas a correr", flush=True)
