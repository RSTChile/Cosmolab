#!/usr/bin/env python3
"""
VSTCosmo - v27.3: Curvatura fuerte, saturación evitada
A no puede crecer sin curvatura. La voz debería destacar.
"""
...
# PARÁMETROS DE A - REDISEÑADOS PARA EVITAR SATURACIÓN
REFUERZO_A = 0.04        # MUY BAJO (antes 0.15)
INHIBICION_A = 0.6       # MUY ALTA (antes 0.2)
DIFUSION_A = 0.02        # BAJA (antes 0.08)
FUERZA_RELIEVE = 0.05    # REDUCIDA

# Competencia global
LIMITE_ATENCION = DIM_FREQ * DIM_TIME * 0.20  # más bajo (antes 0.35)
INHIB_GLOBAL = 0.8       # más fuerte

# Curvatura
PESO_CURVATURA = 12.0    # MUY ALTO
...
FUERZA_ESTABILIDAD = 0.05
BLOQUEO_MAXIMO = 0.8

# Parámetros de Ω
TASA_OMEGA = 0.15
DISIPACION_OMEGA = 0.05
FUERZA_COHERENCIA = 0.1
...
def main():
    print("=" * 100)
    print("VSTCosmo - v27.3: Curvatura fuerte, saturación evitada")
    print("A no puede crecer sin curvatura")
    print("=" * 100)
    ...
    # Verificar si la voz tiene la mayor media
    if voz_res[3] > ruido_res[3] and voz_res[3] > tono_res[3]:
        print("\n" + "=" * 100)
        print("🎉 ¡ÉXITO! La voz tiene la mayor actividad de atención. 🎉")
        ...
        print("\n" + "=" * 100)
        print("⚠️ La voz no tiene la mayor actividad de atención.")
        print("El sistema sigue sin privilegiar la complejidad de la voz.")
        print("Cerramos esta etapa. Hemos explorado múltiples caminos.")
        print("=" * 100)
