#!/usr/bin/env python3
"""
VSTCosmos - v57: Δ_estímulo por Contraste
Mide el efecto diferencial del estímulo aislando la dinámica interna.
Δ_estímulo = respuesta_con - respuesta_sin (en el mismo instante)
La identidad se consolida en función de cuánto cambia realmente el sistema por el acoplamiento.
"""
...
def calcular_ganancia_estructural(estado_before, estado_after, fatiga, delta_estimulo):
    ...
    # Δ_estímulo es ahora la señal de identidad
...
def simular_experiencia_con_contraste(S, entrada_nombre, G, R, C, habituacion_comida, K):
    """
    v57: Simula en paralelo el camino real (con estímulo) y el camino contrafactual
    ...
    # M_sin y L_sin se mantienen fijos (no evolucionan) para no contaminar
    M_sin = M.copy()
    L_sin = L.copy()
    ...
    delta_estimulo = min(1.0, delta_estimulo * 10.0)  # Escalar y saturar
...
def simular_vida_con_contraste(opciones, n_experiencias=100):
    print("=" * 100)
    print("VSTCosmos - v57: Δ_estímulo por Contraste")
    print("Mide el efecto diferencial del estímulo aislando la dinámica interna.")
    print("Δ_estímulo = respuesta_con - respuesta_sin (en el mismo instante)")
    print("La identidad se consolida en función de cuánto cambia realmente el sistema")
    print("por el acoplamiento con el exterior.")
    print("=" * 100)
    ...
    for exp in range(n_experiencias):
        ...
        # Actualizar valor estructural (con Δ_estímulo)
...
def main():
    ...
    print("\n⚠️  V57: Δ_ESTÍMULO POR CONTRASTE")
    print("   - Mide efecto diferencial del estímulo aislando dinámica interna")
    print("   - Ruido blanco → Δ bajo (sin estructura)")
    print("   - Voz/Música → Δ alto (estructura organiza el campo)")
    print("   - La identidad se consolida en función del Δ_estímulo")
    
    historial, K_final, fatiga_final, valor_final = simular_vida_con_contraste(opciones, n_experiencias=100)
    
    print("\n" + "=" * 100)
    print("RESULTADOS FINALES: V57")
    print("=" * 100)
