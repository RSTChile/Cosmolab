#!/usr/bin/env python3
"""
V164 — ANIMA-2 Etapa 3: RITUAL CON JERARQUÍA DE ETAPAS
================================================================================
BASE: V163 (hemisferios, fatiga, memoria, consciencia, juego, ritual)

PRINCIPIO DE DISEÑO:
  - Etapa 0 (Memoria): siempre activa (base)
  - Etapa 1 (Cb): siempre activa (base)
  - Etapa 2 (Juego): se activa por Cb, pero se INHIBE si Ritual está activo
  - Etapa 3 (Ritual): se activa por cruces de cero + Cb > umbral
  - El ritual puede USAR Cb, historia, memoria de etapas anteriores

CRITERIOS DE CIERRE E3:
  1. Tiempo ritual activo > 15%
  2. Activación ritual final > 0.2 (persistencia)
  3. Historia ritual < 0.8 × historia control (compresión)
  4. Ritual activo durante F4 (rigidez, no se apaga fácilmente)
================================================================================
"""
...
# ============================================================
# PARAMETROS RITUAL (AJUSTADOS PARA CIERRE)
# ============================================================
RITUAL_TAU = 200.0
...
# ============================================================
# APARATO MOTOR V164 (CON JERARQUÍA DE ETAPAS)
# ============================================================

class AparatoMotorV164:
    def __init__(self):
        ...
        self.fatiga = FatigaMetabolicaV164()
        self.memoria = MemoriaAusenciaV164()
        self.consciencia = ConscienciaBasicaV164()
        self.juego = ModoJuegoV164()
        self.ritual = Ritual()
    ...
    def actuar(self, gradiente, LF_activa, fuente_activa, t, setpoint_raw):
        ...
        # ============================================================
        if ritual_activo:
            # Ritual activo: inhibe completamente el juego
            juego_activo = False
            self.juego.activo = False
        else:
            # Solo si ritual NO está activo, el juego puede activarse
...
class OrganismoV164:
    def __init__(self, seed):
        ...
        self.izquierdo = HemisferioV164("L", 30.0, generar_ruido_rosa, seed=seed, sesgo=SESGO_L)
        self.derecho = HemisferioV164("R", 300.0, generar_clicks_poisson, seed=seed+100, sesgo=SESGO_R)
        
        self.sistema_B_izq = HemisferioV164("B_L", 30.0, generar_ruido_rosa, seed=seed+200, sesgo=SESGO_L)
        self.sistema_B_der = HemisferioV164("B_R", 300.0, generar_clicks_poisson, seed=seed+300, sesgo=SESGO_R)
        
        self.motor = AparatoMotorV164()
...
def ejecutar_v164():
    print("=" * 100)
    print("EXPERIMENTO V164 — ANIMA-2 Etapa 3: RITUAL CON JERARQUÍA DE ETAPAS")
    print("=" * 100)
    print("  PRINCIPIO:")
    print("    - Etapa 0 (Memoria): siempre activa")
    print("    - Etapa 1 (Cb): siempre activa")
    print("    - Etapa 2 (Juego): se INHIBE si Ritual está activo")
    print("    - Etapa 3 (Ritual): puede usar Cb, historia, memoria")
    print("")
    print("  CRITERIOS DE CIERRE E3:")
    print("    1. Tiempo ritual activo > 15%")
    print("    2. Activación ritual final > 0.2 (persistencia)")
    print("    3. Historia ritual < 0.8 × historia control (compresión)")
    print("    4. Ritual activo durante F4 (rigidez)")
    print("=" * 100)
    
    print("\n  Creando organismos paralelos...")
    organismo_control = OrganismoV164(seed=SEMILLA_BASE)
    organismo_ritual = OrganismoV164(seed=SEMILLA_BASE)
    ...
    # ============================================================
    # F4: Test post - NO forzamos ritual OFF, medimos rigidez
    # ============================================================
    print("\n  F4: Test post (3 ciclos) - midiendo persistencia del ritual...")
    ...
    # ============================================================
    print("\n" + "=" * 80)
    print("RESULTADOS V164 — Etapa 3: Ritual con jerarquía")
    print("=" * 80)
    ...
    print(f"    Diferencia (ritual inhibe): {tiempo_juego_control - tiempo_juego_ritual:.1f}s")
    ...
    print(f"    Ritual activo en F4: {ritual_active_en_F4}")
    ...
    print(f"    Compresión (hist_ritual/hist_control): {historia_ritual/max(1,historia_control):.2f}")
    ...
    # ============================================================
    # CRITERIOS DE CIERRE E3 (redefinidos)
    # ============================================================
    exito_1 = pct_ritual > 15.0
    exito_2 = ritual_activation_final > 0.2
    exito_3 = historia_ritual < 0.8 * historia_control
    exito_4 = ritual_active_en_F4 == True  # Rigidez: persiste en F4
    ...
    print(f"  4. Rigidez (ritual activo en F4): {ritual_active_en_F4} -> {'✅' if exito_4 else '❌'}")
    ...
    if exito:
        ...
        print("     El ritual persiste en F4 (rigidez)")
        print("")
        ...
        if not exito_3:
            print("     Compresión no lograda (historia ritual no es menor)")
        if not exito_4:
...
if __name__ == "__main__":
    import time
    start = time.time()
    control, ritual, exito = ejecutar_v164()
    elapsed = time.time() - start
    print(f"\n  ⏱️ Tiempo de ejecución: {elapsed/60:.1f} minutos")
    print(f"\n  V164 completado. Éxito: {exito}")
