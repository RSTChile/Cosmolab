#!/usr/bin/env python3
"""
V182A-v8 — ACOPLAMIENTO BIDIRECCIONAL CON MEMORIA RELACIONAL (CORREGIDO)
================================================================================
CORRECCIÓN CRÍTICA (GPT):
  - El Paso 5 (comparación) ahora se hace ANTES de almacenar el nuevo resultado
  - Así se compara con el resultado ANTERIOR del otro, no consigo mismo
  - La discrepancia media ahora será > 0 y medirá la verdadera memoria relacional

LOS 8 PASOS (Alexis) CORREGIDOS:
  ...
  5. 🟢 COMPARAN señales con resultados ALMACENADOS (antes de guardar el nuevo)
...
# Capacidad de la memoria relacional
MEMORIA_CAPACIDAD = 10


# ============================================================
# MEMORIA RELACIONAL (CORREGIDA — COMPARACIÓN ANTES DE ALMACENAR)
# ============================================================
class MemoriaRelacional:
    """
    Almacena el historial de resultados recibidos del otro organismo.
    La comparación se hace con el ÚLTIMO resultado almacenado ANTES de guardar el nuevo.
    """
    ...
    def comparar_con_anterior(self, resultado_actual):
        ...
        Retorna (comparacion_dict, diferencia) o (None, 0.0) si no hay historial.
        """
    ...
    def obtener_ultimo(self):
        """Retorna el último resultado almacenado (o None)"""
        if len(self.historial) < 1:
            return None
...
# ============================================================
# RONDA DE ACOPLAMIENTO (8 PASOS — CON COMPARACIÓN ANTES DE ALMACENAR)
# ============================================================
def ronda_acoplamiento(A, B, setpoint, ronda_num, dt=DT_PROCESAMIENTO):
    """
    Los 8 pasos de acoplamiento bidireccional según Alexis.
    CORRECCIÓN: La comparación (Paso 5) se hace ANTES de almacenar el nuevo resultado.
    """
    ...
    # 🟢 PASO 5: COMPARAN con resultados almacenados (ANTES de almacenar)
    ...
    # Ahora almacenan los nuevos resultados
...
# ============================================================
def ejecutar_v182a_v8():
    print("=" * 100)
    print("EXPERIMENTO V182A-v8 — ACOPLAMIENTO BIDIRECCIONAL (COMPARACIÓN CORREGIDA)")
    print("=" * 100)
    print("  CORRECCIÓN CRÍTICA (GPT):")
    print("    - La comparación (Paso 5) se hace ANTES de almacenar el nuevo resultado")
    print("    - Así se compara con el resultado ANTERIOR del otro, no consigo mismo")
    print("")
    print("  LOS 8 PASOS (Alexis) CORREGIDOS:")
    ...
    print("    5. 🟢 COMPARAN con resultados ALMACENADOS (antes de guardar nuevo)")
    ...
    # ============================================================
    print("\n" + "=" * 80)
    print("RESULTADOS V182A-v8 — Acoplamiento Bidireccional (Comparación Corregida)")
    print("=" * 80)
    ...
    print(f"\n  📊 MEMORIA RELACIONAL (Paso 5 corregido):")
    ...
    print("\n" + "=" * 80)
    if exito:
        print("  ✅ ACOPLAMIENTO BIDIRECCIONAL CON MEMORIA RELACIONAL DEMOSTRADO")
        print("")
        ...
        print("     ✓ COMPARACIÓN con resultados almacenados (ANTES de guardar nuevo)")
        print("     ✓ Respuesta basada en discrepancias detectadas")
        print("     ✓ Convergencia progresiva")
    ...
    plt.tight_layout()
    plt.savefig(f'V182_logs/v182a_v8_acoplamiento_{ts}.png', dpi=150)
    print(f"\n  📊 Gráficos guardados: V182_logs/v182a_v8_acoplamiento_{ts}.png")
    ...
    with open(f'V182_logs/v182a_v8_raw_{ts}.json', 'w') as f:
        json.dump(raw_data, f, indent=2)
    print(f"  📁 Datos guardados: V182_logs/v182a_v8_raw_{ts}.json")
