...
Base: v90 exacto.
Cambio único: agregar Ω_orient como nueva variable de acoplamiento.

Ω_orient = correlación coseno entre:
  - config_interna: [geom_medio, busc_medio] — lo que el campo construyó
  - firma_entorno:  [grad_acumulado_pos, grad_acumulado_neg] — lo que el entorno imprime

Positivo: el campo está acoplado con su entorno.
Negativo: el campo contradice la estructura del entorno.

Criterio C31: Ω_orient_F2 > 0  AND  Ω_orient_F2 > Ω_orient_F13

Protocolo: 10 ciclos x 13 fases x 20s.
Sin cambios en parámetros, VECINDADES, act_geom, act_busc, gradE.
"""
...
print("=" * 100)
print("VSTCosmos v92 — Respuesta de orientación Ω_orient")
print("")
print("  Base: v90. Cambio único: Ω_orient = correlación config_interna / firma_entorno")
print("  Criterio C31: Ω_orient_F2 > 0 AND Ω_orient_F2 > Ω_orient_F13")
print("")
