#!/usr/bin/env python3
"""
VSTCosmo - v23: Triple memoria (Ψ, Ω, Σ) - VERSIÓN CORREGIDA (Sigma por consistencia)
Ψ: estabilidad | Ω: coherencia | Σ: estructura en la variación (consistencia del signo de la segunda derivada)
"""
...
# ============================================================
# PARÁMETROS (fijos, tal como estaban en la ejecución exitosa)
# ============================================================
DIM_FREQ = 32
DIM_TIME = 100
DT = 0.01
...
BLOQUEO_MAXIMO = 0.8   # ← este valor es CLAVE (0.8, no reducido)
...
def actualizar_memoria_estructura(Sigma, Phi, Phi_prev, Phi_prev2, A, Sigma_prev):
    ...
    # Signo suave de la segunda derivada
    signo_dd = np.tanh(dd * 5.0)
    signo_dd_prev = np.tanh(Sigma_prev * 5.0)   # proxy del signo anterior
    
    # Consistencia: 1 si el signo se mantiene, 0 si cambia
